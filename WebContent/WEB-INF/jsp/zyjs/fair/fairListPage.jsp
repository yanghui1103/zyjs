...
<body>
      <div id="tb" style="padding:0 30px;">
		<form id="fairlistFM">
        	...
        	<a href="javascript:openAddfair();" class="easyui-linkbutton" iconCls="icon-remove" >关闭招聘会</a> 
        	<a href="javascript:openAddfair();" class="easyui-linkbutton" iconCls="icon-add" >开启招聘会</a> 
        	<a href="javascript:openAddfair();" class="easyui-linkbutton" iconCls="icon-edit" >修改</a> 
        </form>
