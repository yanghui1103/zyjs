...
<body>
      <div id="tb" style="padding:0 30px;">
       ...
       <table id="resumelistDg" style="width:100%;height:480px;" >
        </table>
        <div id="_loadDialog_resumelist"></div>
</body> 
	<script type="text/javascript" src="<%=basePath%>common/js/zyjs/resume/resumeListPage.js"></script>
