...
<body>
      <div id="tb" style="padding:0 30px;">
		<form id="townPoorlistFM">
        	关键词: <input class="easyui-textbox" type="text" name="keyWords" style="width:166px;height:35px;line-height:35px;"></input>
        	<a href="javascript:townPoorReloadgrid();" class="easyui-linkbutton" iconCls="icon-search" data-options="selected:true">查询</a>
        	   	<a href="javascript:openDetail();" class="easyui-linkbutton" iconCls="icon-remove" >详情</a><a
				href="#" class="easyui-linkbutton"
				iconCls="icon-remove">变更户内人员</a>  
        </form>
        <input name="area" id="townPoorlistFMarea" value="${arg }" type="hidden">
      </div>
       <table id="townPoorlistDg" style="width:100%;height:480px;" >
        </table>
        <div id="_loadDialog_townPoorlist"></div>
</body> 
	<script type="text/javascript" src="<%=basePath%>common/js/zyjs/poorCard/townPoorListPage.js"></script>
