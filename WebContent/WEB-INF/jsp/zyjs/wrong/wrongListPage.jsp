...
<body>
      <div id="tb" style="padding:0 30px;">
		<form id="wronglistFM">
        	...
        	<a href="javascript:wrongReloadgrid();" class="easyui-linkbutton" iconCls="icon-search" data-options="selected:true">查询</a> 
        	<a href="javascript:openBlackwrong();" class="easyui-linkbutton" iconCls="icon-remove" >详情</a> 
        </form>
        <input name="area" id="wronglistFMarea" value="${area }" type="hidden">
      </div>
       <table id="wronglistDg" style="width:100%;height:480px;" >
        </table>
        <div id="_loadDialog_wronglist"></div>
</body> 
	<script type="text/javascript" src="<%=basePath%>common/js/zyjs/wrong/wrongListPage.js"></script>
</html>
